...
names(ranger.mod)
#Arreglamos los nombres de las columnas por problemas de compatibilidad
...
pdp = FeatureEffect$new(predictor, feature = 'Net.worth.Assets', method = 'pdp') |> plot()
pdp = FeatureEffect$new(predictor, feature = 'ROA.A..before.interest.and...after.tax', method = 'pdp') |> plot()
pdp = FeatureEffect$new(predictor, feature = 'Interest.Expense.Ratio', method = 'pdp') |> plot()
pdp = FeatureEffect$new(predictor, feature = 'Liability.to.Equity', method = 'pdp') |> plot()
pdp = FeatureEffect$new(predictor, feature = 'Research.and.development.expense.rate', method = 'pdp') |> plot()
pdp
